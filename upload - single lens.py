...
v05_field_before_lens = bk_restore['v05_field_before_lens']
v06_field_after_lens = bk_restore['v06_field_after_lens']
v07_image_wide_field_imaging = bk_restore['v07_image_wide_field_imaging']
v16_final_confocal_field = bk_restore['v16_final_confocal_field']
v17_ism_pic_by_resize1 = bk_restore['v17_ism_pic_by_resize1']
v17_ism_pic_by_resize2 = bk_restore['v17_ism_pic_by_resize2']
v18_ism_pic_by_down_sampling = bk_restore['v18_ism_pic_by_down_sampling']
v19_wide_field_by_sum = bk_restore['v19_wide_field_by_sum']
...
fig1, ax1 = plt.subplots()
im1 = ax1.imshow(np.abs(v07_image_wide_field_imaging.field.to('cpu').numpy()),
...
fig1, ax1 = plt.subplots()
im1 = ax1.imshow(np.abs(v16_final_confocal_field.field.to('cpu').numpy()),
                 extent=v16_final_confocal_field.extent.to('cpu').numpy())
...
fig1, ax1 = plt.subplots()
im1 = ax1.imshow(np.abs(v17_ism_pic_by_resize1.field.to('cpu').numpy()),
                 extent=v17_ism_pic_by_resize1.extent.to('cpu').numpy())
...
fig1, ax1 = plt.subplots()
im1 = ax1.imshow(np.abs(v17_ism_pic_by_resize2.field.to('cpu').numpy()),
                 extent=v17_ism_pic_by_resize2.extent.to('cpu').numpy())
...
fig1, ax1 = plt.subplots()
im1 = ax1.imshow(np.abs(v18_ism_pic_by_down_sampling.field.to('cpu').numpy()),
...
fig1, ax1 = plt.subplots()
im1 = ax1.imshow(np.abs(v19_wide_field_by_sum.field.to('cpu').numpy()),
                 extent=v19_wide_field_by_sum.extent.to('cpu').numpy())
...
#####     post proc     #####
#############################
img = v07_image_wide_field_imaging.field
